...
namespace VRTK
{
    ...
    public class VRTK_InteractGrabTong : VRTK_InteractGrab
    {
        [Header("Grab Settings")]

        [Tooltip("The button used to grab/release a touched Interactable Object.")]
        public new VRTK_ControllerEvents.ButtonAlias grabButton = VRTK_ControllerEvents.ButtonAlias.TriggerPress;
        ...
        public new bool createRigidBodyWhenNotTouching = false;
        ...
        public new Rigidbody controllerAttachPoint = null;
        ...
        public new VRTK_ControllerEvents controllerEvents;
        ...
        public new VRTK_InteractTouch interactTouch;

        /// <summary>
        /// Emitted when the grab button is pressed.
        /// </summary>
        public new event ControllerInteractionEventHandler GrabButtonPressed;
        /// <summary>
        /// Emitted when the grab button is released.
        /// </summary>
        public new event ControllerInteractionEventHandler GrabButtonReleased;

        /// <summary>
        /// Emitted when a grab of a valid object is started.
        /// </summary>
        public new event ObjectInteractEventHandler ControllerStartGrabInteractableObject;
        /// <summary>
        /// Emitted when a valid object is grabbed.
        /// </summary>
        public new event ObjectInteractEventHandler ControllerGrabInteractableObject;
        /// <summary>
        /// Emitted when a ungrab of a valid object is started.
        /// </summary>
        public new event ObjectInteractEventHandler ControllerStartUngrabInteractableObject;
        /// <summary>
        /// Emitted when a valid object is released from being grabbed.
        /// </summary>
        public new event ObjectInteractEventHandler ControllerUngrabInteractableObject;

        protected new VRTK_ControllerEvents.ButtonAlias subscribedGrabButton = VRTK_ControllerEvents.ButtonAlias.Undefined;
        protected new VRTK_ControllerEvents.ButtonAlias savedGrabButton = VRTK_ControllerEvents.ButtonAlias.Undefined;
        protected new bool grabPressed;

        protected new GameObject grabbedObject = null;
        protected new bool influencingGrabbedObject = false;
        protected new int grabEnabledState = 0;
        protected new float grabPrecognitionTimer = 0f;
        protected new GameObject undroppableGrabbedObject;
        protected new Rigidbody originalControllerAttachPoint;

        protected new VRTK_ControllerReference controllerReference
        {
            get
            {
        ...
        public override void OnControllerStartUngrabInteractableObject(ObjectInteractEventArgs e)
        {
        ...
        public override void OnGrabButtonReleased(ControllerInteractionEventArgs e)
        {
        ...
        public override bool IsGrabButtonPressed()
        {
            return grabPressed;
        }
        ...
        public override void ForceRelease(bool applyGrabbingObjectVelocity = false)
        {
        ...
        /// </summary>
        public override void AttemptGrab()
        {
            AttemptGrabObject();
        }
        ...
        public override void ForceControllerAttachPoint(Rigidbody forcedAttachPoint)
        {
        ...
        protected override void ManageGrabListener(bool state)
        {
        ...
        protected override bool IsObjectGrabbable(GameObject obj)
        {
        ...
        protected override bool IsObjectHoldOnGrab(GameObject obj)
        {
            if (obj != null)
            {
                VRTK_InteractableObject objScript = obj.GetComponent<VRTK_InteractableObject>();
        ...
        protected override void ChooseGrabSequence(VRTK_InteractableObject grabbedObjectScript)
        {
...
#pragma warning restore 0618
        ...
        protected override GameObject GetGrabbableObject()
        {
        ...
        protected override void IncrementGrabState()
        {
        ...
        protected override bool ScriptValidGrab(VRTK_InteractableObject objectToGrabScript)
        {
        ...
        protected override void CheckPrecognitionGrab()
        {
